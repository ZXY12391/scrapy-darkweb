...
import  random
class ZwawSpider(RedisSpider):
    name = "zwaw"
    redis_key = "search_url"
    num1=0
    def __init__(self, *args, **kwargs):
        super(ZwawSpider, self).__init__(*args, **kwargs)
        #url和COOKIE每天都变，用这个方法不太好
        url = 'http://mxxxxxxxs7kepo3qh4nmaauztnzh7q3vrcfy4beamgexyw3tqxboj4ad.onion/index.php?parameter=1d77WAr-UxXxugH5hqDTZZ1QSepHd-ZJ7Z3qbx8--ivyJlvAS_ha7xsJb_j_dnlsBzZpxOUDXsyxWTlM-sSbQf0czoFNypQKbMip1XjlmliDDYusBo7UfVGppNynXpfxmEnaDoJt5AM8oCUtMj5K9Ibn6XVgDvJN2sMmxE4'
        # 请替换为您自己的Redis连接信息
    ...
    def parse_product_detail(self, response):
        ...
        cid = response.xpath("//table[@class='table_user_text']/tr[2]/td/a[3]/text()").extract_first()
        url = response.url
        source = "zwaw"
        item = CnawItem()
        item['Source'] = source
